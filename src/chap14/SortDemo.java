...
public class SortDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Time taken for selectionSort on " + nums.length + " items: " + (end - start) / 1000000.0 + " ms");
        ...
        System.out
                .println("Time taken for bubbleSort on " + nums.length + " items: " + (end - start) / 1000000.0 + " ms");
        System.out.println(java.util.Arrays.toString(java.util.Arrays.copyOf(nums, 10)));
        ...
        System.out.println("Time taken for mergeSort on " + nums.length + " items: " + (end - start) / 1000000.0 + " ms");
        Integer[] k = Sorter.mergeSort(numsList).toArray(new Integer[0]);
