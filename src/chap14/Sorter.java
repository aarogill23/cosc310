...
public class Sorter {
     ...
     * 
     * @param unsorted - the original array which will be modified by the sort
     *                 algorithm
     */
    ...
    public static <T extends Comparable<? super T>> ArrayList<T> merge(ArrayList<T> left, ArrayList<T> right) {
         ...
         * if first(left) ≤ first(right) then ... instead of using <=, use compareTo
         * method and check if return value <= 0 otherwise it must have been greater
         * than ... see below:
